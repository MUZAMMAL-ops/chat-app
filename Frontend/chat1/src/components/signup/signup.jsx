 ...
 <form action="">
    <div className='parent'>
        ...
        {/* <div className='Email'>
            ...
            <input className='i2' type="text" name="Name" value={state.name} id="Name1" placeholder='your Name' required onChange={Recievedata}/>
        </div> */}
        <div className='Email'>
            <label htmlFor="Password">Name:</label>
            <input className='i2' type="password" name="Password" value={state.name} id="Password1" placeholder='Password' required onChange={Recievedata} />
        </div>
        {/* <div className='Address'>
            <label htmlFor="Address">Addres:</label>
            <input className='i2' type="text" name="Address" value={state.name} id="Address1" placeholder='Enter your Address' required onChange={Recievedata}/>
        </div> */}
